  ...
  return (
    <div className="py-6">
      <div className="w-full">
        <h3 className="text-base sm:text-lg font-semibold uppercase tracking-wide text-gray-700 mb-4">
          Disclaimer
        </h3>
        <div className="text-sm text-gray-500 space-y-4 leading-relaxed text-justify">
          <p>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-gray-700 mb-1">No Investment Advice</h4>
            <p className="mb-0">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-gray-700 mb-1">Accuracy Not Guaranteed</h4>
            <p className="mb-0">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-gray-700 mb-1">No Liability</h4>
            <p className="mb-0">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-gray-700 mb-1">User Responsibility</h4>
            <p className="mb-0">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-gray-700 mb-1">Jurisdiction</h4>
            <p className="mb-0">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-gray-700 mb-1">Changes</h4>
            <p className="mb-0">
