        ...
        <div className="py-6 md:py-8 space-y-4">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl md:text-3xl font-semibold tracking-tight">
              Compare crypto exchanges for new traders
            </h1>
            <p className="text-sm md:text-base text-slate-300 max-w-2xl">
              Filter by country, products, and fees to find the right on‑ramp and trading venue for
              your first account.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 md:gap-4 bg-slate-900/60 border border-slate-700 rounded-2xl p-3 md:p-4 shadow-lg shadow-slate-900/30">
            <div className="flex flex-wrap gap-3 flex-1 w-full md:w-auto">
              ...
              <select
                ...
                className="px-4 py-2.5 border border-slate-600/80 rounded-xl bg-slate-900/60 text-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent min-w-[150px]"
              >
